...
# def check_if_time_in_message(piece_of_message_with_time):
#     for i in piece_of_message_with_time:
#         try:
#             datetime.datetime.strptime(i, '%H:%M')
#         except ValueError:
#             print("После категории записано не время")
#
#     return piece_of_message_with_time
#
#
...
#         pass
#     # def(проверка что категория существует) если да, то def проверка что 2й и 3й это время, если да, т def проверка
#     # что время начало < время конец
#
#     elif amount_of_parts > 3:
#         raise exceptions.NotCorrectMessage("Проверьте на наличие лишней информации")
#
#     return raw_message  # в случае если все введено верно, возвращаем тот же список, что и пришел
#
#
...
# def processing_of_list(spisok: List):
...
#             date_time_obj)  # добавили к категории время, добавили этот список к списку всех вариков, очистили от
#         # времени категорию)
